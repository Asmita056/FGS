  ...
  return (
    <>
      <div className="bg-[#F3FFCF] min-h-screen p-4">
        <h2 className="text-center font-bold text-4xl p-8">OUR PRODUCT</h2>
        <div className=" text-center p-4 text-[#2E8D49] text-lg">
        ...
        <div className="mb-6 p-4">
          ...
          <div className="flex justify-between px-20">
            <div className="m-5">
              ...
              <div className=" text-center text-xl text-[#143601] mt-5">Purva Nagap</div>
            </div>
            <div className="m-3">
              <img src={Boy} alt="Aditya" className="w-40 h-60" />
              <div className=" text-center text-xl text-[#143601] mt-5">Aditya Thorat</div>
            </div>
            <div className="m-3">
              <img src={Girl} alt="Eshwari" className="w-40 h-60" />
              <div className=" text-center text-xl text-[#143601] mt-5">Eshwari Rampoore</div>
            </div>
            <div className="m-3">
              <img src={Girl} alt="Asmita" className="w-40 h-60" />
              <div className=" text-center text-xl text-[#143601] mt-5">Asmita Ghode</div>
            </div>
          </div>
        </div>
      </div>
